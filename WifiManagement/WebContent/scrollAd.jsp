						...
						$("#editBtn")
								.click(
										function() {
											...
											var content = $(checkedItems).data("content");
											var linkUrl = $(checkedItems).data("linkurl");
											var photoUrl = $(checkedItems).data("photourl");
											$("#id_update_form").val(id);
											$("#content_update_form").val(content);
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<ul class="submenu">
								...
								<li class="active"><a href="scrollAd.action"> <i
			...
			<div class="main-content">
				...
				<div  style="margin-left: 20px;margin-top: 10px;">
					...
					<a href="connect.action?action=previewScrollAd" target="_blank" class="btn btn-info">
  						<span>预览电脑版</span>
					</a>
					<a href="connect.action?action=previewScrollAd&browserType=1" target="_blank" class="btn btn-info">
  						<span>预览手机版</span>
					</a>
					<a href="saveScrollAdRelease.action" class="btn btn-info">
  						<span>保存</span>
					</a>
					
					<a href="cancelScrollAdRelease.action" class="btn btn-info">
  						<span>取消</span>
					</a>
				</div>
						...
						<div class="col-xs-12">
							...
							<div class="table-responsive">
								<table id="sample-table-2"
									...
									<tbody>
										<c:forEach var="temp" items="${requestScope.scrollAds}">
											<tr>
												<td class="center "><label> <input
														type="checkbox" class="ace cbItem" data-id="${temp.id}"
														data-photourl="${temp.photoUrl}"
														data-content="${temp.content}"
														data-linkurl="${temp.linkUrl}" /> <span class="lbl"></span>
												</label></td>
												...
												<td>${temp.linkUrl }</td>
												<td><a
													href="linkCount.action?id=${temp.id}&linkType=2&name=${temp.content }&photoUrl=${temp.photoUrl }&linkUrl=${temp.linkUrl}&fatherPage.name=广告管理&fatherPage.action=scrollAd.action">详情</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
		...
		<div class="modal-dialog">
			<div class="modal-center">
				...
				<div class="widget-box">
					<form id="addForm" class="form-horizontal" action="addScrollAd"
						enctype="multipart/form-data" method="post">
						<div class="widget-header">
							<h4 id="dialogTitle">新建轮播广告链接</h4>
						</div>
							...
							<div class="widget-main">
								...
								<div>
									<label for="form-field-8">链接地址</label> <input
										class="form-control" name="scrollAd.linkUrl"
										id="linkurl_add_form" placeholder="请输入链接地址" />
								</div>

								<div>
									<label for="form-field-8">内容</label> <input
										class="form-control" name="scrollAd.content"
										id="linkurl_add_form" placeholder="请输入内容" />
								</div>
			...
			<div class="modal-center">
				...
				<div class="widget-box">
					<form id="updateForm" class="form-horizontal"
						action="updateScrollAd" enctype="multipart/form-data"
						method="post">
						<div class="widget-header">
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<div>
									<label for="form-field-8">图片</label> <input
										class="form-control" name="fileUpload" type="file"
										id="photourl_update_form" placeholder="图片" />
								</div>

								<div>
									<label for="form-field-select-1" style="margin-top: 5px">文本</label>
									<input class="form-control" name="scrollAd.content"
										id="content_update_form" placeholder="文本" /> </select>
								</div>
