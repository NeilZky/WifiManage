			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li class="active"><a href="#" class="dropdown-toggle"> <i
							class="icon-list"></i> <span class="menu-text">统计</span> <b
							class="arrow icon-angle-down"></b>
					</a>
						<ul class="submenu">
							<c:if
								test="${sessionScope.user.type == 1 || sessionScope.user.type == 2}">
								<li><a href="pageCount.action"> <i
										class="icon-double-angle-right"></i>全网终端访问统计
								</a></li>
								<li class="active"><a href="sellerPageCountList.action"> <i
										class="icon-double-angle-right"></i> 我的商家终端访问统计
								</a></li>
							</c:if>


							<c:if test="${sessionScope.user.type == 3 }">
								<li class="active"><a href="sellerPageCount.action?uid=${sessionScope.user.id }"> <i
										class="icon-double-angle-right"></i> 商家终端访问统计
								</a></li>
							</c:if>
					...
					<li><a href="#" class="dropdown-toggle"> <i
							class="icon-list"></i> <span class="menu-text">素材管理 </span> <b
							class="arrow icon-angle-down"></b>
					</a>
						<ul class="submenu">
							...
							<c:if test="${ sessionScope.user.type == 2}">
								...
								<li><a href="commonArea.action?uid=${sessionScope.user.id}">
										<i class="icon-double-angle-right"></i> 代理商商品管理
								</a></li>
							</c:if>
									...
									<tbody>
										<c:forEach var="user" items="${requestScope.users}">
											<tr>
												...
												<td class="hidden-480"><a href="sellerPageCount.action?uid=${user.id}">管理</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
