								...
								function() {
									...
									$.each($("#updateForm").find(":input"), function(i,temp) {
											if( $(this).attr("id") != "updateSubmit" && $(temp).val().trim() == ""){
												if(valid) {
													$('#warning_update_form').html('请填写完整信息');
													valid = false;
												}
											}
										}
		...
		<div class="main-container-inner">
				...
				<ul class="nav nav-list">
					...
					<li class="active open"><a href="#" class="dropdown-toggle"> <i
						...
						<ul class="submenu">
								...
								<li class="active"><a href="commonAreaList.action"> <i
			...
			<div class="main-content" style="overflow-x: auto;">
				...
				<div  style="margin-left: 20px;margin-top: 10px;">
					...
					<a href="connect.action?action=previewCommonArea&uid=${requestScope.uid}" target="_blank" class="btn btn-info">
  						预览电脑版
					</a>
					<a href="connect.action?action=previewCommonArea&uid=${requestScope.uid}&browserType=1" target="_blank" class="btn btn-info">
  						预览手机版
					</a>
					<a href="saveCommonAreaRelease.action?uid=${requestScope.uid}" class="btn btn-info">
  						保存
					</a>
					
					<a href="cancelCommonAreaRelease.action?uid=${requestScope.uid}" class="btn btn-info">
  						取消
					</a>
				</div>
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-header">公共页面列表</div>
								...
								<table id="sample-table-2"
									...
									<tbody>
										<c:forEach var="temp" items="${requestScope.datas}">
											...
											<td><a
													href="linkCount.action?id=${temp.id}&uid=${temp.uid}&linkType=3&name=${temp.title }&photoUrl=${temp.photoUrl }&linkUrl=${temp.linkUrl}&fatherPage.name=代理商商品管理&fatherPage.action=commonArea.action">详情</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
...
<![endif]-->
	...
	<div id="confirmDeleteDialog" class="modal fade "
		tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
		aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
			...
			<div class="modal-center">
				...
				<div class="widget-box">
					<form id="updateForm" class="form-horizontal"
						action="updateCommonArea.action" enctype="multipart/form-data"
						method="post">
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<div class="clearfix form-actions center"
									...
									<input id="id_update_form" class="form-control" name="ca.id" type="hidden"
										style="height: 0px;width: 0px;"/>
									<input type = "hidden" style="height: 0px;width: 0px;" name="ca.uid" value="${requestScope.uid}" />
								</div>
							</div>
						</div>
					</form>
	...
	<div class="modal fade" id="addDialog">
		<div class="modal-dialog">
			<div class="modal-center">
				<form id="addForm" class="form-horizontal" action="addCommonArea"
